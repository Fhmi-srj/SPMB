                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-6 mb-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" maxLength="10" placeholder="DD/MM/YYYY" value={form.tanggal_lahir || ''} onChange={e => handleDateChange('tanggal_lahir', e.target.value)} className={inputCls} style={{ textTransform: 'none' }} />
                                    </div>
                                    <div>
                        ...
                        <div>
                            <div className="bg-white rounded-2xl shadow-sm p-6 mb-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div><label className="block text-sm font-medium text-gray-700 mb-2">Tanggal Lahir</label><input type="text" maxLength="10" placeholder="DD/MM/YYYY" value={form.tanggal_lahir_ayah || ''} onChange={e => handleDateChange('tanggal_lahir_ayah', e.target.value)} className={inputCls} style={{ textTransform: 'none' }} /></div>
                            ...
                            <div className="bg-white rounded-2xl shadow-sm p-6 mb-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div><label className="block text-sm font-medium text-gray-700 mb-2">Tanggal Lahir</label><input type="text" maxLength="10" placeholder="DD/MM/YYYY" value={form.tanggal_lahir_ibu || ''} onChange={e => handleDateChange('tanggal_lahir_ibu', e.target.value)} className={inputCls} style={{ textTransform: 'none' }} /></div>
