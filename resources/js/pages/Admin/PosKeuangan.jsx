        ...
        <div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-4 mb-4">
                <div className="flex flex-col md:flex-row gap-3 items-center">
                    ...
                    {hasActiveFilters && (
                        <button onClick={handleResetAll} className="w-full md:w-auto bg-gray-500 hover:bg-gray-600 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition flex items-center justify-center gap-2 whitespace-nowrap">
                    ...
                    <table id="posKeuanganTable" className="w-full text-[11px] sm:text-sm">
                        <thead className="bg-gray-50">
                            ...
                            <tr className="bg-gray-50 border-b border-gray-200">
                                <td className="sticky left-0 bg-gray-50 z-10"></td>
                                <td className="sticky left-12 bg-gray-50 z-10"></td>
                                <td className="px-1 py-1">
                                    <select value={filterLembaga} onChange={e => setFilterLembaga(e.target.value)}
                                        className="w-full text-[10px] border border-gray-300 rounded px-1 py-0.5 bg-white text-gray-600 focus:ring-1 focus:ring-[#E67E22] focus:border-[#E67E22] outline-none">
